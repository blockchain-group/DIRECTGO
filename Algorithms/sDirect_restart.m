function [minima, xatmin, history] = sDirect_restart(Problem, opts, bounds)
%--------------------------------------------------------------------------
% Function   : sDirect_restart
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = sDirect_restart(Problem, opts, bounds)
...
while VAL.perror > OPTI.TOL                                 % Main loop
    ...
    POH = Find_po(MSS.FF(1:VAL.I), MSS.LL(:,1:VAL.I), Fmin, VAL.ep,...
        MSS.DD(1:VAL.I));
...
[Fmin, VAL.Fmin_old] = deal(MSS.FF(1));           % initial minima
