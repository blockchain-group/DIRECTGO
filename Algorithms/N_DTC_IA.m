function [minima, xatmin, history] = N_DTC_IA(Problem, opts, bounds)
%--------------------------------------------------------------------------
% Function   : N_DTC_IA
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = N_DTC_IA(Problem, opts, bounds)
...
while VAL.perror > OPTI.TOL                                 % Main loop
    % Selection of potential optimal hyper-rectangles step                              %GL
    POH = Find_poh(MSS.FF(1:VAL.I), MSS.DD(1:VAL.I), 1:VAL.I, VAL); %agressive
