function [minima, xatmin, history] = sDirect_sym2(Problem, opts, bounds)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = sDirect_sym(Problem, opts, bounds)
%       s         - static memory management in data structure
%       glbSolve  - DIRECT(DIvide a hyper-RECTangle) algorithm
%       sym2       -  DIRECT extension for symmetric functions
%
% Input parameters:
