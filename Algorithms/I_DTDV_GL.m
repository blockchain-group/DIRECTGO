function [minima, xatmin, history] = I_DTDV_GL(Problem, opts, bounds)
%--------------------------------------------------------------------------
% Function   : I_DTDV_GL
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = I_DTDV_GL(Problem, opts, bounds)
...
Euclid_dist = sum((Xmin(:, 1) - MSS.CCc(:, 1:VAL.I)).^2, 1).^0.5;

% Identify potential optimal hyper-rectangles
S = Find_pohhi(MSS.FF(1:VAL.I), MSS.DD(1:VAL.I), 1:VAL.I);

D = Find_pohhi(Euclid_dist(1:VAL.I), MSS.DD(1:VAL.I), 1:VAL.I);
...
%--------------------------------------------------------------------------
function boxes = Find_pohhi(fc, szes, indexs)
%--------------------------------------------------------------------------
C     = unique(szes);
