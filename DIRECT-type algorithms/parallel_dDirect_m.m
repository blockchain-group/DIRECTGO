function [ret_minval, final_xatmin, history] = parallel_dDirect_m...
    (Problem, bounds, opts)
%--------------------------------------------------------------------------
% Function   : parallel_dDirect_m
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = parallel_dDirect_m(Problem, bounds, opts)
...
%       m         - eliminate the sensitivity to the additive scaling of
...
%--------------------------------------------------------------------------
    ...
    while VAL.perror > SS.TOL       % Main loop
        [MSS, CE, DT, MD] = subdivision(VAL, Problem, DT, MSS, CE, third, MD);
