function [minima, xatmin, history] = dADC(Problem, bounds, opts)
%--------------------------------------------------------------------------
% Function   : dADC
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = dADC(Problem, bounds, opts)
...
[MSS, CE, VAL, third] = Alocate(bounds, SS);
...
%--------------------------------------------------------------------------
function [MSS, CE, VAL, third] = Alocate(bounds, SS)
%--------------------------------------------------------------------------
...
% alociate MAIN sets
MSS = struct('F', zeros(1), 'FF', zeros(1), 'L', zeros(VAL.n, 1), 'RECT', []);
