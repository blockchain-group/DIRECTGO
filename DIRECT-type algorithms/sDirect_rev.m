function [minima, xatmin, history] = sDirect_rev(Problem, bounds, opts)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = sDirect_rev(Problem, bounds, opts)
...
for i = 1:size(POH, 2)
    ...
    ls = find(MSS.LL(:, POH(i)) == min(MSS.LL(:, POH(i))), 1, 'first');
