function [minima, xatmin, history] = dMrDirect075(Problem, bounds, opts)
%--------------------------------------------------------------------------
% Function   : dMrDirect
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = dMrDirect(Problem, bounds, opts)
...
if level == 2
    ...
    POH = Find_po(MSS, CE, 10^(-5), Fmin, MV, colum);
elseif level == 1
    ...
    POH = Find_po(MSS, CE, 10^(-2), Fmin, MV, colum);
else
    ...
    POH = Find_po(MSS, CE, 0, Fmin, MV, colum);
end
...
%--------------------------------------------------------------------------
function S = Find_po(MSS, CE, SS, minval, MV, colum)
