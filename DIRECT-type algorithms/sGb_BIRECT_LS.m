function [minima, xatmin, history] = sGb_BIRECT_LS(Problem, bounds, opts)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = sGb_BIRECT_LS(Problem, bounds, opts)
...
[VAL, MSS, RECT] = Alocate(bounds, OPTI);
...
getopts(opts, 'maxits', 1000,'maxevals', 100000, 'maxdeep', 1000,...
    ...
    'ep', 1e-4, 'balancedSampling', false, 'tighterLB', false);
...
%--------------------------------------------------------------------------
function [VAL, MSS, RECT] = Alocate(bounds, OPTI)
%--------------------------------------------------------------------------
tic                                     % Mesure time
...
VAL.f_min_general = min(Fmin, VAL.f_min_general);
