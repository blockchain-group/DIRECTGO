function [minima, xatmin, history] = dDirmin(Problem, bounds, opts)
%--------------------------------------------------------------------------
% Function   : dDirmin
...
%--------------------------------------------------------------------------
% [minima, xatmin, history] = dDirmin(Problem, bounds, opts)
...
while VAL.perror > SS.TOL                 % Main loop
    ...
    % Run local searches
    VAL = minlocal(MSS, VAL, Problem, POH);
...
%--------------------------------------------------------------------------
function VAL = minlocal(MSS, VAL, PP, PH)
%--------------------------------------------------------------------------
